...
import net.es.oscars.pss.openflowj.soap.OpenFlowJPSSSoapServer;
...
/**
 * Main class that starts OpenFlowJPSS
 *
 */
public class Invoker {
    ...
    public static void main(String[] args) throws Exception {
        ...
        OpenFlowJPSSSoapServer.setSSLBusConfiguration(
        ...
        if (mode.equals("server")) {
            ...
            try {
                ...
                OpenFlowJPSSCore.getInstance();
                OpenFlowJPSSSoapServer server = OpenFlowJPSSSoapServer.getInstance();
