...
/** AttributeDAO is the data access object for the authZ.attributes table.
 *
...
public class AttributeDAO extends GenericHibernateDAO<Attribute, Integer> {
     ...
     */
    public Integer getIdByValue(String value) throws AuthZException {
        Attribute attr = super.queryByParam("value", value);
        if (attr != null ) {
            return attr.getId();
        } else {
            throw new AuthZException ("No attribute with name "+ value);
        }
    }
}
