package net.es.oscars.pce.l3mpls.common;
...
import net.es.oscars.pce.l3mpls.L3MplsPCEServer;
...
public class Invoker {
    ...
    private static ContextConfig cc = ContextConfig.getInstance(ServiceNames.SVC_PCE_L3MPLS);
    private static String context = ConfigDefaults.CTX_PRODUCTION;

/**
 * Main program to start MPLS PCE server
 ...
 */
    ...
    public static void main(String[] args) throws Exception {
        ...
        parseArgs( args );
        System.out.println("starting Layer 3 MPLS PCE service with context "+ context);
        cc.setContext(context);
        cc.setServiceName(ServiceNames.SVC_PCE_L3MPLS);
        try {
            cc.loadManifest(ServiceNames.SVC_PCE_L3MPLS,  ConfigDefaults.MANIFEST); // manifest.yaml
            cc.setLog4j();
        ...
        L3MplsPCEServer pceServer = new L3MplsPCEServer();
