package net.es.oscars.pss.openflow.common;
...
import net.es.oscars.pss.openflow.soap.OpenFlowPSSSoapServer;
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (mode.equals("server")) {
            ...
            try {
                ...
                OpenFlowPSSSoapServer server = OpenFlowPSSSoapServer.getInstance();
