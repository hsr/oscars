...
public class Invoker {
    private static ContextConfig cc = ContextConfig.getInstance(ServiceNames.SVC_PCE_BW);
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            cc.loadManifest(ServiceNames.SVC_PCE_BW,  ConfigDefaults.MANIFEST); // manifest.yaml
            cc.setLog4j();
